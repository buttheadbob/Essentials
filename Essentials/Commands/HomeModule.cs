...
{
    private readonly RanksAndPermissionsModule RanksAndPermissionsModule = new ();
    private readonly PlayerAccountModule PlayerAccounts = new ();
    ...
    public void addHome(string homeName) 
    {
        ...
        PlayerAccountModule.PlayerAccountData? Account = PlayerAccounts.GetAccount(Context.Player.SteamUserId);
        RanksAndPermissionsModule.RankData? Rank = RanksAndPermissionsModule.GetRankData(Account.Rank);
