...
public class RanksModule : CommandModule {
    ...
    public PlayerAccountModule AccModule = new ();
    public RanksAndPermissionsModule RanksAndPermissions = new ();
    ...
    public void SetRank(string playerNameOrID, string rankName) {
        ...
        PlayerAccountModule.PlayerAccountData? data = new ();
    ...
    public void AddInheritance(string rankName, string inheritanceName) 
    {
        ...
        Context.Respond("The rank you are trying to add inheritance to does not exist");
    }
    ...
    {
        RanksAndPermissionsModule.RankData data = new ();
        bool found = false;
        ...
        {
            string stringAfterChar = command.Substring(command.IndexOf("-", StringComparison.Ordinal) + 1);
