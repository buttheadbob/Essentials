...
public class EssentialsPlugin : TorchPluginBase, IWpfPlugin
{
    ...
    private HashSet<ulong> _motdOnce = [];
    ...
    private readonly RanksAndPermissionsModule? RanksAndPermissions = new ();
    private static bool _initilized = false;

    /// <inheritdoc />
    public UserControl GetControl() => _control ??= new PropertyGrid{DataContext=Config/*, IsEnabled = false*/};
    ...
    private void SessionChanged(ITorchSession session, TorchSessionState state)
    {
        ...
        switch (state)
        {
            ...
            case TorchSessionState.Loaded:
                ...
                if (Config.EnableRanks && RanksAndPermissions is not null) 
                {
    ...
    static string GetDefaultMotdText()
    {
        try
        {
            ...
            var motd = motdConstructFunc?.Invoke(null, []);
